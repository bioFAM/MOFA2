...
if __name__ == '__main__':
    ...
    ent.set_model_options(ard_z=True, sl_w=True, sl_z=False, ard_w=True, factors=4, likelihoods=lik, learnTheta=False)
    ent.set_train_options(iter=10, tolerance=0.01, dropR2=0.0, seed=1)
    ent.build()

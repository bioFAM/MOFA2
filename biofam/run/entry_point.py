...
if __name__ == '__main__':
    ent = entry_point()
    dir = '/Users/damienarnol1/Documents/local/pro/PhD/FA/biofam/paper_figures/simul_data/sl_simulations_2/simul_2//'
    ...
    lik = ["gaussian"]
    #
    outfile = dir+"test_rob_fa_ard_bis_2.hdf5"
    #
    ...
    ent.set_model_options(ard_z=False, sl_w=False , sl_z=False, ard_w=True, factors=30, likelihoods=lik)
    ent.set_train_options(iter=1000, tolerance=.0, dropR2=0.0, seed=2, elbofreq=1, verbose=1)

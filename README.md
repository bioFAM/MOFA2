...
* [**Analysis of a multi-group scRNA-seq data set (in R)**](https://github.com/bioFAM/MOFA2/blob/master/MOFA2/vignettes/scRNA_gastrulation.html): Figure 2 of the paper, in preparation...

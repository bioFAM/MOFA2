...
package: MOFA2
vignette: >
  %\VignetteIndexEntry{MOFA2: Applying MOFA2 to the CLL multi-omics data}
...
```
## Enrichment analysis
In addition we can use enrichment analysis to look for siginificant associaitons of factors to genesets. Here, we use the Reactome genesets for illustrations, which is contained in the `MOFAdata` package.
```{r}

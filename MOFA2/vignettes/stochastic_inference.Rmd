...
```{r, message=FALSE}
# We will use default data and training options (see ?prepare_mofa)
...
## Setting up the GPU
The Python core of MOFA () can take advantage of NVIDIA GPUs to massively speed up training. For this you have to install and configure the [cupy](https://docs-cupy.chainer.org/en/stable/install.html) package, which is an open-source matrix library accelerated with NVIDIA CUDA.  Please, read their website for installation details.

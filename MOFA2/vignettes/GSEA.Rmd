...
- **(2) Select a gene set statistic**: the statisic used to quantify the scores at the pathway level. Must be one of the following: `mean.diff` (difference in the mean weight between foreground and background) or `rank.sum` (difference in the sum of ranks between foreground and background).  
